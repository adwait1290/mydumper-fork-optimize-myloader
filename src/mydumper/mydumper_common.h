...
// OPTIMIZATION: Returns new length after escaping to avoid strlen() in hot path
unsigned long m_escape_char_with_char(gchar neddle, gchar replace, gchar *to, unsigned long length);
void free_common();
